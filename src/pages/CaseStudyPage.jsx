  ...
  'case-02': {
    ...
    sections: [
      ...
      },
      {
        ...
        text: 'Translating research insights into core user stories surfaced one central requirement: urban Nigerian buyers don\'t just want a faster, more convenient way to buy a car — they want one they can trust. Transparent pricing, clear financing options, and honest documentation proved just as important as the digital experience itself.',
      ...
      },
      {
        ...
        text: 'Synthesizing 400+ deal logs and buyer interviews surfaced three critical system breakdowns: (1) the "18-Minute Manual Entry Tax" of re-typing identical customer fields across 6 portals, (2) a Pre-Approval Predictability Gap where 71% of managers guessed lender fit blindly, and (3) Customer Trust Decay during long waiting periods with the buyer seated across the desk. These operational failures are the same inconvenience, opacity, and delay that push urban buyers toward abandoning physical dealership visits, while most buyers now expect a trusted contactless path to ownership with flexible payment options.',
      ...
      },
      {
        ...
        text: 'Iterative co-design workshops with 15 dealership F&I managers mapped user mental models and co-created human-centered credit intake workflows. The findings distilled into 4 core UX principles: single intake form, multi-lender orchestration, instant eligibility pre-screen, and automated contract execution.',
      ...
      },
      {
        ...
        text: 'Both sides of the journey were validated through 3 rounds of evaluative usability testing: simulated live deal scenarios with 15 dealership finance managers on the credit execution flow, and task-based sessions with urban buyers on the contactless purchase flow. On the dealer side we measured completion velocity, field error rates, and System Usability Scale (SUS) scores under real sales-desk pressure; on the buyer side we tracked comprehension, trust, and willingness to complete a purchase digitally.',
        mockLabel: 'Evaluative Usability Testing Scorecard — Buyer Journey & Deal Velocity',
        mockType: 'triple-card',
      },
      {
        id: 'impact',
        title: 'Outcome & Impact',
        text: 'Verse increases adoption and conversion compared to traditional dealerships. The end-to-end flow replaces paper-heavy processes with secured, convenient virtual documentation, while inspection and flexible payment options build the trust and accessibility urban buyers need to commit.',
        mockLabel: 'Dealership Adoption & Buyer Journey Impact',
        mockType: 'impact-dashboard-grid',
      },
      {
        id: 'reflections',
        title: 'Reflections',
        text: 'This work highlighted the importance of trust and transparency in the Nigerian car market, showing that addressing these factors is just as critical as providing convenience or digital access. Removing friction matters — but trust is what ultimately moves a buyer from browsing to ownership.',
